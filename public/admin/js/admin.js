...
(function () {
    ...
    app.controller('ArtisanCtrl', ['$scope', '$http', 'UrlBuilder', function ($scope, $http, UrlBuilder) {
        ...
        $scope.commandsFilter = function (item) {
            if (!$scope.commandsQuery || item.name.toLowerCase().indexOf($scope.commandsQuery) != -1 || item.description.toLowerCase().indexOf($scope.commandsQuery.toLowerCase()) != -1) {
                return true;
            }
            return false;
        };
...
(function () {
    ...
    app.controller('CategoryController', ['$scope', '$http', 'UrlBuilder', '$location', function ($scope, $http, UrlBuilder, $location) {
    ...
    app.controller('CategoryTreeController', ['$http', 'UrlBuilder', function ($http, UrlBuilder) {
        ...
        this.remove = function (scope, msg) {
            if (scope.$nodeScope && confirm(msg || 'Delete?')) {
                ...
                $http.post(UrlBuilder.get('category/delete/' + id)).then(function (r) {
                    scope.remove();
                });
            }
        };
        ...
        this.treeOptions = {
            beforeDrop: function beforeDrop(e) {
                ...
                return $http.post(UrlBuilder.get('category/move/' + section_id + '/' + id), params).then(function (r) {
                    return true;
                });
            }
        };
...
(function () {
    ...
    app.controller('MenuController', ['$scope', '$http', 'UrlBuilder', '$location', function ($scope, $http, UrlBuilder, $location) {
    ...
    app.controller('MenuTreeController', ['$http', 'UrlBuilder', function ($http, UrlBuilder) {
        ...
        this.remove = function (scope, msg) {
            if (scope.$nodeScope && confirm(msg || 'Delete?')) {
                ...
                $http.post(UrlBuilder.get('menuman/items/delete/' + id)).then(function (r) {
                    scope.remove();
                });
            }
        };
        ...
        this.treeOptions = {
            beforeDrop: function beforeDrop(e) {
                ...
                return $http.post(UrlBuilder.get('menuman/items/' + menu_id + '/move/' + id), params).then(function (r) {
                    return true;
                });
            }
        };
        ...
        return {
            ...
            link: function link(scope, elem, attr) {
                ...
                scope.modal.nextPage = function () {
                    if (typeof scope.modal.current_page != 'undefined' && typeof scope.modal.data.pagination.last_page != 'undefined' && scope.modal.current_page < scope.modal.data.pagination.last_page) {
                        scope.modal.current_page++;
                    }
                };
            ...
            link: function link(scope, elem, attrs) {
                ...
                if (iconUrl) {
                    var formatResult = function formatResult(item) {
                        ...
                        var $item = $('<span><img src="' + iconUrl + '/' + item.element.value.toLowerCase() + '" class="img-flag" /> ' + item.text + '</span>');
                        return $item;
                    };
