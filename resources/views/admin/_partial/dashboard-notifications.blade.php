<div class="card shd">
    <div class="card-header">
        <div class="btn-group btn-group-sm pull-xs-right">
            ...
            <a href="#" class="btn btn-outline-secondary" data-toggle="collapse" data-target="#notifications"
    ...
    <div class="list-group collapse in" id="notifications">
        <a href="#" ng-repeat="item in $ctrl.items" class="list-group-item list-group-item-action" data-toggle="modal" data-target="#notificationDetails" ng-click="$ctrl.details(item)">
