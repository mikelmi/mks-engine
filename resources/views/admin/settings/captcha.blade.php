...
@section('form')
    <div class="form-group row">
        <label class="col-sm-3 col-form-label text-sm-right"> @lang('a.Type') </label>
        <div class="col-sm-9">
    ...
    <div ng-show="captchaType=='recaptcha'">
        <div class="form-group row">
            <label class="col-sm-3 col-form-label text-sm-right"> @lang('a.SiteKey') </label>
            <div class="col-sm-9">
                <input type="text" name="config[sitekey]" value="{{ $model->get('config.sitekey', config('captcha.sitekey')) }}" class="form-control" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-3 col-form-label text-sm-right"> @lang('a.SecretKey') </label>
            <div class="col-sm-9">
