...
Watch 107
Star 1,512
Fork 666 caouecs/Laravel-lang
Code  Issues 1  Pull requests 0  Projects 0  Wiki  Pulse  Graphs
Branch: master Find file Copy pathLaravel-lang/src/ru/validation.php
6605037  25 days ago
@sportsoft sportsoft translated validation: uploaded
3 contributors @sportsoft @fernandobandeira @caouecs
RawBlameHistory
135 lines (126 sloc)  9.81 KB
<?php
return [
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'captcha' => 'Невeрный код',

    'invalid_value'           => 'Поле :attribute содержит неверное значение.',
    ...
    */
    'attributes' => [
        ...
        'email' => 'E-mail',
        'password' => 'Пароль',
        'password_current' => 'Поточный пароль',
